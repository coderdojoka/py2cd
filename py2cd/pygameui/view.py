...
class View(object):
    ...
    def layout(self):
        ...
        """
        if self.shadowed:
            shadow_size = theme.aktive_szene.shadow_size
    ...
    def stylize(self):
        ...
        for child in self.children:
            child.stylize()
        style = theme.aktive_szene.get_dict(self)
    ...
    def add_child(self, child):
        ...
        child.parented()
        from . import szene
        if szene.aktive_szene is not None:
            child.stylize()
