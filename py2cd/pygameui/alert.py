...
class AlertView(dialog.DialogView):
    ...
    def layout(self):
        ...
        self.title_label.frame.h = theme.aktive_szene.label_height
        ...
        self.ok.frame.h = theme.aktive_szene.button_height
        self.cancel.frame.h = theme.aktive_szene.button_height
    ...
    def taste_unten(self, key, code):
        dialog.DialogView.taste_unten(self, key, code)
...
def show_alert(message, title='Info', buttons=OK):
    ...
    from . import szene
    szene.aktive_szene.add_child(alert_view)
    alert_view.focus()
    alert_view.center()
